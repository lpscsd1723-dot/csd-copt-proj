...
const EnhancedServicesSection: React.FC = () => {
  ...
  const serviceData = [
    ...
    },
    {
      ...
      achievements: [
        t(
          'homepage.services.healthcare.achievements.0',
      ...
      cases: [
        {
          ...
          description: t('homepage.services.healthcare.cases.0.description', '輔導中化生醫「中化優質居家照顧服務網絡推動發展計畫」、敏盛醫控「全天候貼心安養連鎖服務模式推動計畫」、安心食品（摩斯）與東捷資訊「MOS優質健康整合社交行動服務」。'),
          features: [
          ...
          results: [
            t('homepage.services.healthcare.cases.0.results.0', '辦理43場照管專業課程與工作坊，培訓超過2,000人次'),
            t('homepage.services.healthcare.cases.0.results.1', '研擬照管人員資格訓練公版講義共36小時'),
            t('homepage.services.healthcare.cases.0.results.2', '建立研發與推動照顧服務指標10項'),
            t('homepage.services.healthcare.cases.0.results.3', '建立照管品質與考評指標10項'),
            t('homepage.services.healthcare.cases.0.results.4', '縮短全國新案服務核定作業時效為4.8天')
          ],
          image: require('../assets/img/services/健康照護-長期照顧/long-term-care-2019.JPG')
        },
        {
          company: t('homepage.services.healthcare.cases.1.company', '地方政府長照品質監測與輔導'),
          services_item: t('homepage.services.healthcare.cases.1.services_item', '地方政府長照品質監測與輔導'),
          title: t('homepage.services.healthcare.cases.1.title', '縣市政府長期照顧服務特約單位輔導暨品質監測計畫'),
          summary: t('homepage.services.healthcare.cases.1.summary', '強化長照特約單位的管理與品質，針對縣市政府的輔導'),
          description: t('homepage.services.healthcare.cases.1.description', '新北市「111-114年新北市長期照顧服務特約單位輔導暨品質監測計畫」、高雄市「112-114年高雄市居家式長照機構品質監測暨訓練課程計畫」及「高雄市社區整合型服務中心A單位評鑑暨品質提升策進訓練」、嘉義縣、基隆市、新竹縣等衛生局的長照數據分析案。 '),
          features: [
      ...
      results: (() => {
        const resultsData = t('homepage.services.healthcare.results', { returnObjects: true });
        return Array.isArray(resultsData) ? resultsData : [
          {
            title: '基礎網絡建構成果',
            items: [
      ...
      processes: (() => {
        const processesData = t('homepage.services.healthcare.processes', { returnObjects: true });
        return Array.isArray(processesData) ? processesData : [
          {
            title: '顧問輔導流程',
